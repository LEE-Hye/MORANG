...
<body>
  ...
  <div class="app">
    ...
    <nav class="sidebar">
      ...
      <h1>Menu</h1>
      <nav class="menu">
        <a href="메인 샘플k.html" class="menu-item is-active">HOME</a>
        <a href="산전 우울증.html" class="menu-item">우울증 자가진단</a>
        <a href="#" class="menu-item">일기장</a>
        <a href="#" class="menu-item">산모수첩</a>
            ...
            <div id="modal" class="modal_Wrap">
              <div class="modal_Content">
                ...
                <ul class="tabs">
                  ...
                  <div>
                    <div>
                      <textarea name="title" rows="1.5" cols="80" placeholder="여기가 제목이야" class="title" name="#" id="content_id"></textarea>
                    </div>
                    <div>
                      <textarea name="content" rows="20" cols="60" placeholder="여기는 본문 내용 써" class="content" name="#" id="content_sh"></textarea>
                    </div>
                    <div class="weather">
                      <div>
                        <ul class="icon">
    ...
    <img src="resources/img/soohyeon.gif" alt="실패" id="shbot" width="200px" height="160px">
      <img src="resources/img/chatbotimg.png" alt="실패" id="chatbot_close" width="200px" height="160px">
