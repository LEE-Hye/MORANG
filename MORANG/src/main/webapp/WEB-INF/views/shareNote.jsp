	...
	<div class="app">
		...
		<div class="share_note">
			...
			<div class="share_note1">
				...
				<div class="share_content">여기는 제목이라능 용이라능 메모 하나 남겨여기는 내용이라능 메모
					하나 남겨여기는 내용이라능 메모 하나 남겨여기는 내용이라능 메모 하나 남겨여기는 내용이라능 메모 하나 남겨여기는
					내용이라능 메모</div>
			...
			<div class="share_note2">
				<div class="share_content">여기겨여기는 내용이라능 메모 하나 남겨여기는 내용이라능 메모
					하나 남겨여기</div>
				<div class="share_title">제목</div>
				<div class="share_date">2022-05-45</div>
			</div>
			...
			<div class="share_note3">
				<div class="share_content">여기는 제목이라능 용이라능 메모 하나 남겨여기는 내용이라능 메모
					하나 남겨여기는 내용이라능 메모 하나 남겨여기는 내용이라능 메모 하나 남겨여기는</div>
				<div class="share_title">제목</div>
				<div class="share_date">2022-05-45</div>
			</div>
			...
			<div class="share_note4">
				<div class="share_content">여기는 제목이라능 용이라능 메모 하나 남겨여기는 내용이라능 메모
					하나 남겨여기는 내용이라능 메모 하나 남겨여기는 내용이라능 메모여기는 내용이라능 메모 하나 남겨여기</div>
				<div class="share_title">제목</div>
				<div class="share_date">2022-05-45</div>
			</div>
			...
			<div class="popup">
				<form action="#">
					...
					<div class="popup-foot">
						...
						<button class="pop-btn close" id="close3">
							창 닫기</span>
					</div>
				</form>
			</div>
		...
		<div class="popup-wrap" id="popup">
			<div class="popup">
				<div class="popup-head">
					<span class="head-title"> 공유수첩 상세</span>
				</div>
				<div class="popup-body">
					<div class="body-content">
						<div class="body-titlebox">
						...
						<div class="body-contentbox">
							<p>여기는 제목이라능 용이라능 메모 하나 남겨여기는 내용이라능 메모 하나 남겨여기는 내용이라능 메모 하나
								남겨여기는 내용이라능 메모 하나 남겨여기는 내용이라능 메모 하나 남겨여기는 내용이라능 메모</p>
						</div>
		...
		<div id="confirm">
			<div class="popup-wrap" id="popup2">
				<div class="popup">
					<form action="#">
						<div class="popup-head">
							<span class="head-title"> 공유수첩 수정</span>
						</div>
						<div class="popup-body">
							<div class="body-content">
								<div class="body-titlebox">
						...
						<div class="popup-foot">
							...
							<button class="pop-btn close" id="close2">
								닫기</span>
						</div>
					</form>
				</div>
