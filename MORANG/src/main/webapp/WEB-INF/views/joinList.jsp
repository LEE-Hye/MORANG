  ...
  <div class="app">
    ...
    <nav class="sidebar">
      ...
      <nav class="menu">
        ...
        <div class="notice-Join">
            <div class="notice-Join-body">
            
                <% List<Join> list = (List<Join>) request.getAttribute("list");%>
                        
                        <table class="notice-Join-list">
                            <tr style="background-color: rgb(240, 129, 129);">
                                <td>아이디</td>
                                <td>이름</td>
                                <td>닉네임</td>
                                <td>휴대폰번호</td>
                        ...
                        <%for (Join Join : list) {%>
                            <tr>
                                <td><%=Join.getU_id()%></td>
                                <td><%=Join.getU_name()%></td>
                                <td><%=Join.getU_nick()%></td>
